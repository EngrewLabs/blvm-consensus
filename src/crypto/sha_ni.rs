...
unsafe fn sha256_ni_impl(data: &[u8]) -> [u8; 32] {
    ...
    for chunk in padded.chunks_exact(64) {
        ...
        // Rounds 0-3
        msg = _mm_add_epi32(msg0, _mm_set_epi32(K[3] as i32, K[2] as i32, K[1] as i32, K[0] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        msg = _mm_shuffle_epi32(msg, 0x0E);
        state0 = _mm_sha256rnds2_epu32(state0, state1, msg);

        // Rounds 4-7
        msg = _mm_add_epi32(msg1, _mm_set_epi32(K[7] as i32, K[6] as i32, K[5] as i32, K[4] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        msg = _mm_shuffle_epi32(msg, 0x0E);
        state0 = _mm_sha256rnds2_epu32(state0, state1, msg);
        ...
        // Rounds 8-11
        msg = _mm_add_epi32(msg2, _mm_set_epi32(K[11] as i32, K[10] as i32, K[9] as i32, K[8] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        msg = _mm_shuffle_epi32(msg, 0x0E);
        state0 = _mm_sha256rnds2_epu32(state0, state1, msg);
        ...
        // Rounds 12-15
        msg = _mm_add_epi32(msg3, _mm_set_epi32(K[15] as i32, K[14] as i32, K[13] as i32, K[12] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        ...
        // Rounds 16-19
        msg = _mm_add_epi32(msg0, _mm_set_epi32(K[19] as i32, K[18] as i32, K[17] as i32, K[16] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        ...
        // Rounds 20-23
        msg = _mm_add_epi32(msg1, _mm_set_epi32(K[23] as i32, K[22] as i32, K[21] as i32, K[20] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        ...
        // Rounds 24-27
        msg = _mm_add_epi32(msg2, _mm_set_epi32(K[27] as i32, K[26] as i32, K[25] as i32, K[24] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        ...
        // Rounds 28-31
        msg = _mm_add_epi32(msg3, _mm_set_epi32(K[31] as i32, K[30] as i32, K[29] as i32, K[28] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg3, msg2, 4);
        msg0 = _mm_add_epi32(msg0, tmp);
        msg0 = _mm_sha256msg2_epu32(msg0, msg3);
        ...
        // Rounds 32-35
        msg = _mm_add_epi32(msg0, _mm_set_epi32(K[35] as i32, K[34] as i32, K[33] as i32, K[32] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg0, msg3, 4);
        msg1 = _mm_add_epi32(msg1, tmp);
        msg1 = _mm_sha256msg2_epu32(msg1, msg0);
        ...
        // Rounds 36-39
        msg = _mm_add_epi32(msg1, _mm_set_epi32(K[39] as i32, K[38] as i32, K[37] as i32, K[36] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg1, msg0, 4);
        msg2 = _mm_add_epi32(msg2, tmp);
        msg2 = _mm_sha256msg2_epu32(msg2, msg1);
        ...
        // Rounds 40-43
        msg = _mm_add_epi32(msg2, _mm_set_epi32(K[43] as i32, K[42] as i32, K[41] as i32, K[40] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg2, msg1, 4);
        msg3 = _mm_add_epi32(msg3, tmp);
        msg3 = _mm_sha256msg2_epu32(msg3, msg2);
        ...
        // Rounds 44-47
        msg = _mm_add_epi32(msg3, _mm_set_epi32(K[47] as i32, K[46] as i32, K[45] as i32, K[44] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg3, msg2, 4);
        msg0 = _mm_add_epi32(msg0, tmp);
        msg0 = _mm_sha256msg2_epu32(msg0, msg3);
        ...
        // Rounds 48-51
        msg = _mm_add_epi32(msg0, _mm_set_epi32(K[51] as i32, K[50] as i32, K[49] as i32, K[48] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg0, msg3, 4);
        msg1 = _mm_add_epi32(msg1, tmp);
        msg1 = _mm_sha256msg2_epu32(msg1, msg0);
        ...
        // Rounds 52-55
        msg = _mm_add_epi32(msg1, _mm_set_epi32(K[55] as i32, K[54] as i32, K[53] as i32, K[52] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg1, msg0, 4);
        msg2 = _mm_add_epi32(msg2, tmp);
        msg2 = _mm_sha256msg2_epu32(msg2, msg1);
        ...
        // Rounds 56-59
        msg = _mm_add_epi32(msg2, _mm_set_epi32(K[59] as i32, K[58] as i32, K[57] as i32, K[56] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        tmp = _mm_alignr_epi8(msg2, msg1, 4);
        msg3 = _mm_add_epi32(msg3, tmp);
        msg3 = _mm_sha256msg2_epu32(msg3, msg2);
        ...
        // Rounds 60-63
        msg = _mm_add_epi32(msg3, _mm_set_epi32(K[63] as i32, K[62] as i32, K[61] as i32, K[60] as i32));
        state1 = _mm_sha256rnds2_epu32(state1, state0, msg);
        msg = _mm_shuffle_epi32(msg, 0x0E);
        state0 = _mm_sha256rnds2_epu32(state0, state1, msg);
...
mod tests {
    ...
    fn test_sha256_matches_reference() {
        ...
        for input in test_cases {
            ...
            assert_eq!(&result[..], &expected[..], "Mismatch for input length {}", input.len());
        }
    }
